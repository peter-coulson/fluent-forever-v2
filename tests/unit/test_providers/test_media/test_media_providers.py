...
class TestForvoProvider:
    ...
    def test_generate_audio(self, mock_get):
        ...
        request = MediaRequest(type="audio", content="hola", params={"language": "es"})
...
class TestOpenAIProvider:
    ...
    def test_generate_image(self):
        ...
        request = MediaRequest(
            type="image", content="a red apple", params={"size": "512x512"}
        )
...
class TestRunwareProvider:
    ...
    def test_generate_image(self):
        """Test image generation (placeholder implementation)"""
        request = MediaRequest(
            type="image", content="a blue car", params={"width": 512, "height": 512}
        )
    ...
    def test_batch_processing(self):
        ...
        with patch.object(self.provider, "generate_media") as mock_generate:
            mock_generate.return_value = MediaResult(
                success=True, file_path=Path("/fake/path/image.jpg"), metadata={}
            )
...
class TestMediaRequest:
    ...
    def test_media_request_creation(self):
        ...
        request = MediaRequest(
            type="image", content="test prompt", params={"size": "512x512"}
        )
    ...
    def test_media_request_defaults(self):
        ...
        request = MediaRequest(type="image", content="test", params=None)
...
class TestMediaResult:
    ...
    def test_media_result_defaults(self):
        ...
        result = MediaResult(success=False, file_path=None, metadata=None)
