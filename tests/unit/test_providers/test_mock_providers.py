...
class TestMockMediaProvider:
    ...
    def test_generate_media(self):
        ...
        request = MediaRequest(
            type="image", content="test image", params={"filename": "test.jpg"}
        )
...
class TestMockSyncProvider:
    ...
    def test_sync_templates(self):
        ...
        templates = [{"Name": "Card 1", "Front": "Front HTML", "Back": "Back HTML"}]
    ...
    def test_sync_media(self):
        """Test media syncing"""
        media_files = [Path("/test/image1.jpg"), Path("/test/audio1.mp3")]
