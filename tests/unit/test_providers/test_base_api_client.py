...
class MockAPIClient(BaseAPIClient):
    ...
    def get_service_info(self):
        """Get service info"""
        return {"service": "test_api", "status": "connected"}
...
class TestBaseAPIClient:
    ...
    def setup_method(self):
        ...
        test_config = {
            "providers": {
                "test_api": {"api_key": "test_key", "base_url": "https://api.test.com"}
            }
        }
    ...
    def test_api_error_creation(self):
        ...
        error = APIError(message="Test error", status_code=400, retry_after=60)
    ...
    def test_rate_limiting_handling(self, mock_get):
        ...
        response = APIResponse(
            success=False, status_code=429, retry_after=60, error_message="Rate limited"
        )
