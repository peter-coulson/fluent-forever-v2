...
class TestConfigManager:
    ...
    def _create_test_configs(self):
        ...
        core_config = {
            ...
            "paths": {"media_base": "media"},
        }
        (self.config_dir / "config" / "core.json").write_text(json.dumps(core_config))

        # Pipeline config
        pipeline_config = {
            "pipeline": {"name": "test_pipeline", "stages": ["stage1", "stage2"]}
        }
        ...
        # Provider config
        provider_config = {"provider": {"type": "test_provider", "enabled": True}}
        ...
        legacy_config = {
            "apis": {"openai": {"enabled": True}, "anki": {"enabled": True}},
...
class TestConfigValidator:
    ...
    def test_valid_configuration(self):
        ...
        valid_config = {
            ...
            "paths": {"media_base": "media"},
            "pipelines": {"test": {"stages": ["stage1", "stage2"]}},
