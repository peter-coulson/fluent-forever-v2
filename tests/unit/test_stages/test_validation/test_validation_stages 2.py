...
class TestIPAValidationStage:
    ...
    def setup_method(self):
        ...
        self.stage = IPAValidationStage(data_key='vocabulary_data', dictionary_path='/nonexistent/path')
    ...
    def test_valid_ipa_data(self):
        ...
        self.context.set_data('vocabulary_data', valid_data)
    ...
    def test_invalid_ipa_data(self):
        ...
        self.context.set_data('vocabulary_data', invalid_data)
    ...
    def test_malformed_data(self):
        ...
        self.context.set_data('vocabulary_data', malformed_data)
...
class TestMediaValidationStage:
    ...
    def test_valid_media_data(self):
        ...
        self.context.set_data('media_data', valid_data)
    ...
    def test_missing_files(self):
        ...
        self.context.set_data('media_data', data_with_missing_files)
        ...
        with patch('pathlib.Path.exists') as mock_exists:
            ...
            assert result.status in [StageStatus.SUCCESS, StageStatus.PARTIAL_SUCCESS, StageStatus.FAILURE]
    ...
    def test_invalid_media_format(self):
        ...
        self.context.set_data('media_data', invalid_data)
    ...
    def test_empty_media_data(self):
        ...
        self.context.set_data('media_data', empty_data)
...
class TestValidationStageBase:
    ...
    def test_validation_stage_error_handling(self):
        ...
        context.set_data('test_data', None)
