...
class TestCLIPipelineIntegration:
    ...
    def test_cli_list_command_detailed(
        self, config_file, pipeline_registry, provider_registry, capsys
    ):
    ...
    def test_cli_info_command_pipeline(
        self, config_file, pipeline_registry, provider_registry, capsys
    ):
    ...
    def test_cli_info_command_stages(
        self, config_file, pipeline_registry, provider_registry, capsys
    ):
    ...
    def test_cli_error_handling_missing_pipeline(
        self, config_file, pipeline_registry, provider_registry, capsys
    ):
        ...
        assert (
            ...
            or "nonexistent_pipeline" in error_output
        )
    ...
    def test_cli_argument_validation(
        ...
        test_args = [
            ...
            str(config_file),
            "run",
        ]  # Missing pipeline and stage/phase
    ...
    def test_complete_discovery_workflow(
        self, config_file, pipeline_registry, provider_registry
    ):
