...
from tests.fixtures.pipelines import MockPipeline, SuccessStage
...
class TestLoggingPerformanceIntegration:
    ...
    def test_logging_setup_with_file(self, temp_log_dir):
        ...
        setup_logging(level=logging.DEBUG, log_to_file=True, log_file_path=log_file)
    ...
    def test_context_aware_logging(self, project_root):
        ...
        assert logger.name == f"fluent_forever.{module_name}.{pipeline_name}"
