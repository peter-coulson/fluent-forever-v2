...
from cli.utils.output import print_success, print_error, print_warning
from cli.utils.validation import validate_arguments, validate_word_list, validate_card_list
...
class RunCommand:
    ...
    def execute(self, args) -> int:
        ...
        if getattr(args, 'dry_run', False):
            print_warning(f"DRY RUN: Would execute stage '{args.stage}' on pipeline '{args.pipeline}'")
