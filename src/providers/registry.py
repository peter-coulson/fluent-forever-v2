...
class ProviderRegistry:
    ...
    def get_media_providers_by_type(self, media_type: str) -> List[MediaProvider]:
        ...
        """
        return [
            provider for provider in self._media_providers.values()
    ...
    def get_provider_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'media_providers': {
                ...
                'by_type': {
                    'image': [name for name, provider in self._media_providers.items() 
                             if provider.supports_type('image')],
                    'audio': [name for name, provider in self._media_providers.items() 
...
class MediaProviderFactory:
    ...
    def create_provider(self, provider_name: str, **kwargs) -> Optional[MediaProvider]:
    ...
    def create_openai_provider(self, api_key: Optional[str] = None) -> MediaProvider:
    ...
    def create_runware_provider(self, api_key: Optional[str] = None) -> MediaProvider:
    ...
    def create_forvo_provider(self, api_key: Optional[str] = None) -> MediaProvider:
    ...
    def create_mock_provider(self, supported_types: Optional[List[str]] = None, 
                           should_fail: bool = False) -> MediaProvider:
        ...
        return MockMediaProvider(supported_types=supported_types, should_fail=should_fail)
    
    def create_provider_with_fallback(self, config: Dict[str, Any]) -> Optional[MediaProvider]:
    ...
    def get_primary_provider(self) -> Optional[MediaProvider]:
...
class SyncProviderFactory:
    ...
    def create_mock_provider(self, provider_name: str = "anki", should_fail: bool = False) -> SyncProvider:
