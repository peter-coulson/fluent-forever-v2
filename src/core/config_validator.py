        ...
        for pipeline_name, pipeline_config in pipelines.items():
            ...
            if 'pipeline' in pipeline_config:
                ...
                if 'stages' not in nested_pipeline:
                    errors.append(f"Pipeline {pipeline_name} pipeline section missing required field: stages")
                ...
                if 'stages' not in pipeline_config:
                    errors.append(f"Pipeline {pipeline_name} missing required field: stages")
