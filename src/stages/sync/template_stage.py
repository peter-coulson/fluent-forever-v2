...
class TemplateSyncStage(APIStage):
    ...
    def execute_api_call(self, context: PipelineContext, provider: Any) -> StageResult:
        ...
        try:
            ...
            has_diffs = self.has_template_diffs(local_templates, anki_templates, local_css, anki_css)
    ...
    def has_template_diffs(self, local_templates, anki_templates, local_css, anki_css):
        ...
        try:
            ...
            return has_template_diffs(local_templates, anki_templates, local_css, anki_css)
        except ImportError:
    ...
    def push_templates(self, provider, templates, css):
        ...
        try:
            ...
            self.logger.warning(f"{ICONS['warning']} Template push not available (sync module missing)")
